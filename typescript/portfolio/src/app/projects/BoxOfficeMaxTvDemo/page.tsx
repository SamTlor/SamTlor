        ...
        <div className={styles.page}>
            ...
            <div className="flex flex-col space-y-4 items-start pl-6">
                ...
                <Link href="/projects/BoxOfficeMaxTvDemo/queries" 
                    className="px-6 py-3 bg-textHighlight text-black font-semibold text-lg rounded-full shadow-md hover:bg-black hover:text-white transition duration-300 ease-in-out text-center">
                    🔍 Queries
                </Link>
            </div>
