...
select 
    indicator_code,
    format(sum(yr1990), 0) as yr1990,
    format(sum(yr2019), 0) as yr2019
from 
    wdi_data
where
    1=1
...
select 
    region,
    format(pop_total_1990, 0) as pop_total_1990,
    format(pop_total_2020, 0) as pop_total_2020,
